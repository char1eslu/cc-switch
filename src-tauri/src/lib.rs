...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_codex_trashed_threads,
            commands::restore_codex_trashed_thread,
            commands::delete_codex_trashed_thread,
            commands::empty_codex_thread_trash,
            commands::empty_codex_backup_trash,
